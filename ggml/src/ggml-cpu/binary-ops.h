...
void ggml_compute_forward_mod(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_gather_elements(const struct ggml_compute_params * params, struct ggml_tensor * dst);
